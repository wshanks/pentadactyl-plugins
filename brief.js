...
commands.execute(':group plugin-brief -n '+
	'-desc="group generated by brief.js plugin" -locs ' + Brief.BRIEF_URL);
// Previous command restricts all group methods to Brief.BRIEF_URL.
...
// group.autocmd.add(['DOMLoad'], Brief.BRIEF_URL, function() {expandselected()})
...
function setPasskeys(addPasskeys) {
	...
	var briefPasskeys = "'"+Brief.BRIEF_URL+"':"+defaultPasskeys;
